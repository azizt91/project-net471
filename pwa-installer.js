...
class PWAInstaller {
    ...
    handleInstallPrompt() {
        ...
        window.addEventListener('appinstalled', () => {
            ...
            this.showSuccessMessage('NET471 berhasil diinstall!');
        });
    }
    ...
    showInstallButton() {
        ...
        const isAllowedPage = lastSegment === '' || lastSegment === 'index.html' || lastSegment === 'dashboard.html' || lastSegment === 'project-billing-net471';
        
        if (container && !this.isInstalled && isAllowedPage) {
