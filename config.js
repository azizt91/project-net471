...
const config = {
    ...
    API_BASE_URL: 'https://script.google.com/macros/s/AKfycbzibkfR3yhVCaGMQdefMFwN4IF4tE7TWVxaaCe1UrMiYtDkbqJy1FZ5KGxj-g456lBm/exec', // <-- GANTI DENGAN URL WEB APP ANDA
